...
import CampaignProfileCard from '../../components/campaign-profile-card';
import CampaignFieldCard from '../../components/campaign-field-card';
import { statusToNumber } from '../../utils/utils';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div className="form-control">
              ...
              <select
                ...
                value={statusToNumber(campaignData.status!)}
